...
const BaziRuleEngine = {
  ...
  calculateStrength(dayGan, gans, zhis) {
    ...
    if (!springEarthPressure && !killingSealWithoutFoodControl && !summerWoodNeedsSeal && !coldWetEarthOverleak && !winterEarthPressure && rootNetworkBaseScore >= 2.8 && rootNetworkBaseScore < 5.65) {
