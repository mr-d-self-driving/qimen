...
function buildAnnualScoreHits({
  ...
  return {
    ...
    summary: {
      ...
      debug: `base=70, rawBeforeTiaohou=${rawBeforeTiaohou}, tiaohouRatio=${tiaohouRatio}, rawAfterTiaohou=${rawAfterTiaohou}, rawBeforeCaps=${rawBeforeCaps}, layer1=${layer1.layer1_score}, layer2=${layer2.layer2_score}, layer3=${layer3.layer3_score}, caps=${capLabels.join('|') || 'none'}, final=${finalScore}`,
    },
    layers,
  };
}
