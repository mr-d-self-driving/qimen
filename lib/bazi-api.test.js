...
test('buildCompleteBaziDetail exposes the full method chain for frontend and question prompts', () => {
  ...
  assert.ok(result.matrix.dayun_list.length >= 10);
  ...
  assert.ok(result.matrix.liunian_list.length > 10);
...
test('pattern analysis promotes suspected special force patterns to the final pattern axis', () => {
