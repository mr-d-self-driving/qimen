...
function buildScoreHits({
  ...
  return {
    ...
    summary: {
      ...
      debug: `base=70, rawBeforeTiaohou=${rawBeforeTiaohou}, tiaohouRatio=${tiaohouRatio}, rawAfterTiaohou=${rawAfterTiaohou}, rawTotal=${rawTotal}, layer1=${layer1.layer1_score}, layer2=${layer2.layer2_score}, layer3=${layer3.layer3_score}, kongwang_cap=${isKongWang}, final=${finalScore}`,
    },
    layers,
  };
}
  ...
  if (yimaZhi && monthZhi === yimaZhi) {
    ...
    if (yimaTier === 'yong' || yimaTier === 'xi') {
      ...
      hits.push(createHit({
        ...
        debug: `monthZhi=${monthZhi}, yimaZhi=${yimaZhi}, tier=${yimaTier}, raw +5`,
      ...
      hits.push(createHit({
        ...
        debug: `monthZhi=${monthZhi}, yimaZhi=${yimaZhi}, tier=${yimaTier}, raw -2`,
        meta: { monthZhi, yimaZhi },
      }));
    } else {
      raw3 += 2;
