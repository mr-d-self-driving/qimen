...
- summary.score_basis：positive_signals/negative_signals 必须分别呼应极性覆盖后的有利面与风险面。
- analysis.pattern：必须说明该格局为何在当前问题域发生极性变化。
- domain_view：相关 axes 或 process 的 evidence/tone 必须采用覆盖后的语义，tone 可为 positive、mixed 或 warning。`;
}
