...
test('domain axes prompt feeds differentiated M2 yongshen cards', () => {
  ...
  assert.match(careerSection, /M2 领域用神卡片规则/);
  assert.match(careerSection, /qimen_report\.m2_basis\.yongshen_cards/);
  assert.match(careerSection, /不要额外输出 domain_view/);
