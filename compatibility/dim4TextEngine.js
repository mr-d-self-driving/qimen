...
const BADGE_TIERS = [
  {
    min: 71,
    badge: '命定贵人 ✦',
    subtext: '死磕大半个月拿不下的破项目，他过来随便指点两句，不仅雷全排了，还顺手帮你把KPI拉满了。纯纯的开挂带飞，遇到这种大腿建议直接供起来。',
  },
  {
    min: 41,
    badge: '彼此成就',
    subtext: '俩人随便找个地儿碰方案，原本一团乱麻的脑子就像突然连上了5G，不仅思路彻底打开，连敲键盘都比平时快一倍，干啥都贼顺畅。',
  },
  {
    min: 11,
    badge: '有些助益',
    subtext: '哪怕只是周末约在咖啡馆面对面坐着赶工，也会莫名觉得今天状态奇佳，不知不觉就把拖延了一整周的活儿给清空了。',
  },
  {
    min: -10,
    badge: '基本中性',
    subtext: '坐在同一张桌子上，你疯狂肝你的进度条，他安心摸他的鱼。互相帮不上啥大忙，但也绝不互相添乱，主打一个相安无事的平行宇宙。',
  },
  {
    min: -Infinity,
    badge: '带点阻力',
    subtext: '只要他一热心肠凑过来给你出谋划策，不是电脑文档突然崩了，就是刚理清的思路全乱套了。真不是他故意的，但正经搞钱干大事时，建议物理隔离。',
  },
];
