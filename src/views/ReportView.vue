    ...
    <div class="page-wrap">
      <div class="container">
        ...
        <div class="report-list">
          <!-- 合盘报告 -->
          <a href="/wrapped.html" class="report-card card-friendship">
          ...
          <!-- 占位卡 1 -->
          <div class="report-card card-locked">
...
.report-card:not(.card-locked):active {
...
.card-friendship:hover .card-arrow {
